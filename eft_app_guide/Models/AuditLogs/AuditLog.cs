using eft_app_guide.Models.AuditLogs.Config;
using eft_app_guide.Models.AuditLogs.Enums;
using Microsoft.EntityFrameworkCore;
using System.ComponentModel.DataAnnotations;

namespace eft_app_guide.Models.AuditLogs
{
    ...
    public class AuditLog
    {
        ...
        public List<AuditLog> AssociatedLogs { get; set; } = [];
        #endregion
    }
}
